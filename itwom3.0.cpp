...
void __point_to_point(double elev[], double tht_m, double rht_m, double eps_dielect, double sgm_conductivity, double eno_ns_surfref, double frq_mhz, int radio_climate, int pol, double conf, double rel, double &dbloss, char *strmode, int &errnum);

void point_to_point(double elev[], double tht_m, double rht_m, double eps_dielect, double sgm_conductivity, 
	double eno_ns_surfref, double frq_mhz, int radio_climate, int pol, 
	double conf, double rel, double &dbloss, char *strmode, int &errnum){

	int i;
	printf("-----------------------------------------------------------------------\n");
	printf("point_to_point: \n");
	printf("  elev[0] = %f\n", elev[0]);
	printf("  elev[1] = %f\n", elev[1]);
	printf("  elev[2..n] = ");
	for (i = 0; i < elev[0]; i++){ // print 
		printf(" %f,", elev[2+i]);
	}
	printf("\n");
	...
	printf("eps_dielect: %f\n", eps_dielect);
	printf("sgm_conductivity: %f\n", sgm_conductivity);
	printf("eno_ns_surfref: %f\n", eno_ns_surfref);
	printf("freq_mhz: %f\n", frq_mhz);
	printf("radio climate: %d\n", radio_climate);
	printf("pol: %d\n", pol);

	printf("conf: %f\n", conf);
	printf("rel: %f\n", rel);
	__point_to_point(elev, tht_m, rht_m, eps_dielect, sgm_conductivity, eno_ns_surfref,
		frq_mhz, radio_climate, pol, conf, rel, dbloss, strmode, errnum);
	printf("dbloss: %3.2f\n", dbloss);
	printf("strmode: %s\n", strmode);
	printf("errnum: %d\n", errnum);
	printf("-----------------------------------------------------------------------\n");
